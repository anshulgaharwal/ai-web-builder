              ...
              if (isMessage) {
                ...
                return (
                  ...
                  >
                    {!isUser && (
                      <div
                        className="w-8 h-8 rounded-full bg-linear-to-br from-indigo-600
                    ...
                    <div
                      className={`max-w-[80%] p-2 px-4 rounded-2xl shadow-sm text-sm
                    ...
                    <div className="flex items-center justify-between">
                      {project.current_version_index === ver.id ? (
                        ...
                        <button
                          ...
                          className="px-3 py-1 rounded-md te4xt-xs bg-indigo-500
